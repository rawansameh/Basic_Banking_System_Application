  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<BankCubit,BankSatates>(
      ...
      var cubit=BankCubit.get(context);
        return Scaffold(
      appBar: AppBar(title: Center(child: Text("Transaction History",style:TextStyle(fontWeight: FontWeight.w100,color: Colors.purple,fontFamily: 'Lobster',fontSize: 30)),)),
