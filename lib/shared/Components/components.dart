...
Widget userItem(Map user,context)
{
  return Padding(padding: EdgeInsets.symmetric(horizontal: 15,vertical: 10),
          child: Row(
            children: [
              Text("${user['id']}",style: TextStyle(color: Colors.deepPurpleAccent,fontSize: 25,fontFamily: 'Lobster'),),
              SizedBox(width: 30,),
              Expanded(child: Column(
                mainAxisAlignment: MainAxisAlignment.start,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("${user['name']}",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,color: Colors.deepPurple,),),
                  SizedBox(height:6),
                  Text("${user['email']}"),
  ...
  return Padding(padding: EdgeInsets.all(20),
          child: Center(
            ...
            children: [
              ...
              }, child: Text("Details",style: TextStyle(color: Colors.deepPurpleAccent),)),
...
Widget usersList({required List<Map>users})
{
  ...
  else
  {
    ...
    pathBackgroundColor: Colors.purple,    /// Optional, the stroke backgroundColor
)
...
Future<void> _displayTextInputDialog(BuildContext context,int transactionamount,String transactiondate,String sender,String reciever) async {
  return showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: Text('Transaction details',style:TextStyle(fontWeight: FontWeight.w100,color: Colors.purple,fontFamily: 'Lobster',fontSize: 20),),
            ...
            child:
                SizedBox(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Text("Sender:",style: TextStyle(color: Colors.deepPurpleAccent,fontWeight: FontWeight.w600,fontSize: 15)),
                        SizedBox(width: 10,),
                        Text("${sender}")
                      ],
                    ),
                    ...
                    SizedBox(height:5),
                                      ...
                                      Row(
                      children: [
                        Text("Reciever:",style: TextStyle(color: Colors.deepPurpleAccent,fontWeight: FontWeight.w600,fontSize: 15)),
                        SizedBox(width: 10,),
                        Text("${reciever}")
                      ],
                    ),
                    SizedBox(height:5),
                                      Row(
                      children: [
                        Text("Amount:",style: TextStyle(color: Colors.deepPurpleAccent,fontWeight: FontWeight.w600,fontSize: 15)),
                        SizedBox(width: 10,),
...
SizedBox(height:5),
                                      Row(
                      children: [
                        Text("Date&Time:",style: TextStyle(color: Colors.deepPurpleAccent,fontWeight:FontWeight.w600,fontSize: 15)),
                        SizedBox(width: 1,),
